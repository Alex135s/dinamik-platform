...
function Website() {
  ...
  const handleWhatsapp = () => {
    window.open(
      "https://wa.me/51962744341?text=Hola, me gustaría obtener más información sobre sus servicios.",
      "_blank",
    );
  };
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section
        id="inicio"
        className="pt-20 min-h-screen bg-gray-950 flex items-center"
      >
        <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-5xl font-black text-white mt-4 leading-tight">
              Ingeniería que
              <br />
              <span className="text-orange-500">construye</span>
              <br />
              confianza
            </h2>
            <p className="text-gray-400 mt-6 text-lg leading-relaxed">
              En DINAMIK eliminamos la brecha entre arquitectura, estructura y
              ejecución. Protegemos la rentabilidad de tu proyecto desde el
              primer trazo.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 mt-4 max-w-xl mx-auto">
              Soluciones integrales de ingeniería para desarrolladores,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-2xl border border-gray-100 hover:border-orange-300 hover:shadow-xl transition-all group overflow-hidden"
              >
                <div
                  className={`h-1.5 w-full ${s.color} group-hover:h-2 transition-all`}
                />
                <div className="p-6">
                  <div
                    className={`${s.color} w-12 h-12 rounded-xl flex items-center justify-center mb-4`}
                  >
      ...
      <footer className="bg-black py-8 text-center">
        <p className="text-gray-500 text-sm">
          © 2026 DINAMIK DK GROUP SAC · Ingeniería que construye confianza
        </p>
      </footer>
    </div>
  );
