...
function Settings() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-2">⚙️ {t.settings}</h1>
      ...
      <div className="grid gap-6 max-w-2xl">
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h2 className="text-white font-semibold mb-1">🎨 {t.theme}</h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              <div className="w-10 h-10 bg-gray-950 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        {/* Idioma */}
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h2 className="text-white font-semibold mb-1">🌐 {t.language}</h2>
        ...
        {/* Info del sistema */}
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h2 className="text-white font-semibold mb-4">ℹ️ Información del Sistema</h2>
